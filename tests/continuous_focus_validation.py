...
check("frontend honestly states guide/ONAG is not yet coupled", "Guide-/ONAG-Echtzeitquelle ist in " in FRONTEND and "AFS_VERSION_TEXT_W" in FRONTEND and " noch nicht gekoppelt" in FRONTEND)
...
check("native sanitizer suite includes the continuous focus helper", "continuous_focus_logic_validation.cpp" in RUNNER)
