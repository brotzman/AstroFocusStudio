...
validator = (root / "tests" / "github_workflow_validation_390.py").read_text(encoding="utf-8-sig")
...
checks = [
    ...
    ("KNOWN_LIMITATIONS_3_9_0.txt" in required_block, "preflight requires the current known-limitations payload"),
