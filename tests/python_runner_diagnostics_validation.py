...
validator = (root / "tests" / "github_workflow_validation.py").read_text(encoding="utf-8-sig")
...
checks = [
    ...
    ("KNOWN_LIMITATIONS.txt" in required_block, "preflight requires the current known-limitations payload"),
