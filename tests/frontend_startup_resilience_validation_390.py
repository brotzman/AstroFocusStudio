...
check("GUI smoke test requires the real main-window title", "MainWindowHandle" in SMOKE and "AstroFocus Studio 3.9.0*" in SMOKE)
...
check("workflow preflight includes the startup regression", "tests\\frontend_startup_resilience_validation_390.py" in WORKFLOW)
