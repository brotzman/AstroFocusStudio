...
lld-link /nologo /machine:x64 /timestamp:0 /subsystem:windows /entry:WinMainCRTStartup /nodefaultlib updater_launcher.obj security_cookie.obj security_entry.obj chkstk.obj kernel32.lib user32.lib /out:AstroFocusUpdater.exe || exit /b 1
clang-cl /nologo /W4 /WX /O2 /GS /DUNICODE /D_UNICODE /c setup_launcher.cpp /Fo:setup_launcher.obj || exit /b 1
lld-link /nologo /machine:x64 /timestamp:0 /subsystem:windows /entry:WinMainCRTStartup /nodefaultlib setup_launcher.obj security_cookie.obj security_entry.obj chkstk.obj kernel32.lib user32.lib /out:AstroFocusSetup.exe || exit /b 1
endlocal
