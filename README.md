...
[`KNOWN_LIMITATIONS.txt`](KNOWN_LIMITATIONS.txt) dokumentiert.
...
Die enthaltene `LICENSE` behält alle Rechte vor. Für eine Open-Source-Veröffentlichung muss der Rechteinhaber sie bewusst durch eine passende Lizenz ersetzen.
